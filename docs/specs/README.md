...
| Session autonaming | [`session-autoname.md`](session-autoname.md) | **BUILD** (done) | Default first-party extension that asynchronously titles persisted unnamed main sessions after the first completed substantive real-user exchange in interactive TUI and RPC modes. |
