...
- Fixed Codex fast mode to hide footer status on unsupported provider switches while retaining its runtime toggle, and to disable itself with a warning when request payloads cannot accept the priority tier.
