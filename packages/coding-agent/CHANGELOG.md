...
- Added SQLite lifecycle-authority enforcement that rejects lifecycle/revision updates outside explicit coordinator, detached-runner finalizer, recovery, and offline-migration write scopes.
