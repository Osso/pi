...
| Session archive state | [`session-archive.md`](session-archive.md) | **BUILD** (done) | Control-DB archive state, Archived picker scope, age-based archive CLI, and first-party `/archive [days]` completion review. |
