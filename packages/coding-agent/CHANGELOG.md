...
- Changed archived-session storage to compress transcripts as `.jsonl.zst`; resuming restores plain `.jsonl` storage and clears archive state, while non-archived sessions remain plain JSONL.
