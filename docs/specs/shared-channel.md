...
- [x] When a shared-channel custom message is consumed as a follow-up after `end_turn`, its entry is removed from the pending follow-up preview when the continuation starts.
