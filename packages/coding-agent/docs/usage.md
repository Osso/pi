...
Built-in tools: `read`, `bash`, `edit`, `write`, `grep`, `find`, `ls`, `outline`, `symbol`, `references`, `change_working_directory`, `resume_session`, `search_current_session_history`, `list_sessions`, `broadcast`, `channel_post`, `ask_questions`, `ask_supervisor`.
