...
- `packages/coding-agent/test/resource-loader.test.ts` — sorted global rules, markdown-only filtering, empty-file skip, global/project merge order, and project trust gating.
