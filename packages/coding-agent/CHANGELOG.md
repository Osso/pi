...
- Added durable multi-agent recovery-leader storage so competing sweepers can be fenced by lease identity, runtime incarnation, owner, epoch, renewal, and expiry.
