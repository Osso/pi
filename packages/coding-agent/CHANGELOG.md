...
- Added a distinct Supervisor `wait` goal decision so corrected or resumed goals stay active without duplicate continuation while asynchronous agent work is already running.
