...
// ============================================================================
// OAuth API key resolution from the global agent auth.json
// ============================================================================
...
/**
 * Resolve API key for a provider from the global agent auth.json
 *
...
/**
 * Check if a provider has credentials in the global agent auth.json
 */
...
/**
 * Get an AuthStorage instance backed by the global agent auth.json
