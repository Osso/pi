...
- Transcript metadata updates now merge transactionally into the latest persisted agent snapshot without rewriting lifecycle/revision from stale store state, and restore no longer persists runtime worker-handle cleanup.
