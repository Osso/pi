...
- Routed selected-agent Escape cancellation through the same coordinator runtime operation as `cancel_agent`; InteractiveMode no longer directly terminalizes or aborts store state.
