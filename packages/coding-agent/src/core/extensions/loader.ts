...
import * as _bundledPiAiBase from "@earendil-works/pi-ai";
...
function getAliases(): Record<string, string> {
	...
	const resolveWorkspaceOrImport = (workspaceRelativePaths: string | string[], specifier: string): string => {
		const candidates = Array.isArray(workspaceRelativePaths) ? workspaceRelativePaths : [workspaceRelativePaths];
...
export function createExtensionRuntime(): ExtensionRuntime {
	...
	const runtime: ExtensionRuntime = {
		...
		requestResumeContinuation: notInitialized,
		...
		callTool: () => Promise.reject(new Error("Extension runtime not initialized")),
		callCommand: () => Promise.reject(new Error("Extension runtime not initialized")),
...
function createExtensionAPI(
	...
	const api = {
		...
		requestResumeContinuation(): void {
			runtime.assertActive();
			runtime.requestResumeContinuation();
		},
		...
		callCommand(name: string, args?: string) {
			runtime.assertActive();
			return runtime.callCommand(name, args);
		},
