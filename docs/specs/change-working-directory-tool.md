...
- [x] Control metadata persists the current cwd, while the JSONL header remains the immutable initial cwd; `cwd_changed` entries preserve historical transitions for rewind and branch context.
