...
- `packages/coding-agent/src/supervisor/service.ts` — builds additive goal-set and exception-based goal-progress prompt contracts, then parses typed Supervisor decisions.
