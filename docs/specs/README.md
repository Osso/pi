...
| OpenRouter model catalog cache | [`model-catalog-cache.md`](model-catalog-cache.md) | **BUILD** (done) | Seven-day XDG cache adds newly listed OpenRouter models without replacing bundled metadata. |
