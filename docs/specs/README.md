...
| Session selector search | [`session-selector-search.md`](session-selector-search.md) | **NATIVE** | Resume-picker phrase, regex, literal-first, and fuzzy-fallback search behavior. |
