...
- [x] Keep non-archived sessions and the sole live transcript for each resident Supervisor and Architect role as plain `.jsonl` files; opening a role prunes its stale transcript files and metadata.
