...
const HOSTRUN_PROMPT_GUIDELINES = [
	...
	"Use pi.agents.spawn(...), pi.agents.list(...), pi.agents.wait(), and pi.messages.enqueue(...) for the supported Pi runtime bridge; pi.agents.wait() waits for any active agent and returns no agent output.",
